...
def evaluate(df, beta, gamma):
    ...
    print("=" * 65)
    print(f"{'USD/INR — Adaptive Threshold Model (EMA5 − EMA20)':^65}")
    print(f"{'Flip signal if last 2 non-abstained predictions both wrong':^65}")
    print("=" * 65)
    print(f"  Beta  (upper threshold) : {beta:.4f}")
    print(f"  Gamma (lower threshold) : {gamma:.4f}")
